...
const fetchHospitalDoctors = async () => {
  try {
    ...
    // Use the public demo endpoint to avoid authentication issues
    const response = await axios.get(`${hospitalApiUrl}/api/demo/doctors`, { timeout: 10000 });

    // The demo API returns data in response.data.data
